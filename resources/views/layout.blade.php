     ...
     @yield('header')
      ...
      <div class="sidebar">
        ...
        <div class="side-links">
          <ul>
            <li><a class="{{Request::routeIs('welcome.index') ? 'active' : ''}}" href="/">Home</a></li>
           ...
           <li><a class="{{Request::routeIs('login') ? 'active' : ''}}" href="{{route('login')}}">Login</a></li>
            <li><a class="{{Request::routeIs('dashboard') ? 'active' : ''}}" href="{{route('register')}}">Register</a></li>
           @endguest
           
           @auth
           <li><a class="{{Request::routeIs('register') ? 'active' : ''}}" href="{{route('dashboard')}}">Dashboard</a></li>
          @endauth
          </ul>
        </div>
